...
public class TagNotExistException extends RuntimeException{
     ...
     * @since 1.4
     */
    public TagNotExistException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected TagNotExistException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
